# Auto-converted from /home/granny-src-full/Granny - Source/Assets/Scripts/ObjectFallFloorDestroys.cs by cs2gd.py (best-effort).
# Review every TODO before relying on this script.


class_name ObjectFallFloorDestroys
extends Node  # TODO: was MonoBehaviour
  func _ready():
    Granny = GameObject.Find("GrannyParent")

  func OnTriggerEnter(other: Variant):
    if other.gameObject.tag == "golv"  and  not touchGround:
      touchGround = true
