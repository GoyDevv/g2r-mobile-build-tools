# Auto-converted from /home/granny-src-full/Granny - Source/Assets/Scripts/bedEyes.cs by cs2gd.py (best-effort).
...
extends Node  # TODO: was MonoBehaviour
  func _ready():
    self  # TODO: was transform.localEulerAngles = Vector3(0.0, -90.0, 0.0)
    playerStop = GameObject.Find("BedCam1")
