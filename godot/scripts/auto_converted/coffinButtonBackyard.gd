# Auto-converted from /home/granny-src-full/Granny - Source/Assets/Scripts/coffinButtonBackyard.cs by cs2gd.py (best-effort).
# Review every TODO before relying on this script.


class_name coffinButtonBackyard
extends Node  # TODO: was MonoBehaviour
  ...
  func TaskOnClick():
    if not PlayerHiding:
      ...
      underBedCam.self  # TODO: was transform.localEulerAngles = Vector3(0.0, -180.0, 0.0)
      coffinLock.self  # TODO: was transform.localEulerAngles = Vector3(lockRotXNer, 0.0, 0.0)
      ...
      ((soundEffects)soundHolder.GetComponent(typeof(soundEffects))).CoffinIn()
    else:
      ...
      coffinLock.self  # TODO: was transform.localEulerAngles = Vector3(lockRotXUpp, 0.0, 0.0)
      PlayerHiding = false
